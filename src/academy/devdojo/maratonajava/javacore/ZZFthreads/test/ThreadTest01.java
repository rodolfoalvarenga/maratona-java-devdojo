...
// Daemon => Não tem tanta prioridade ex: Garbage Collector
// User => Java encerra um programa quando todas as Threads do tipo User são terminadas, mesmo que as do tipo Daemon estejam sendo executadas
